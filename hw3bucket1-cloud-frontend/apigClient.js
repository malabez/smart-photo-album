...
apigClientFactory.newClient = function (config) {
    ...
    if(config === undefined) {
        config = {
            accessKey: 'AKIAJX2AFXM2VEKDYX7Q',
            secretKey: '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',
            sessionToken: '',
            region: 'us-east-1',
            apiKey: undefined,
    ...
    var invokeUrl = 'https://80ekmxkib3.execute-api.us-east-1.amazonaws.com/first';
